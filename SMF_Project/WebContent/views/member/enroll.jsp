                ...
                <div class="join_area">
                    ...
                    <div class="input_box" id="email_input_box">
                        ...
                        <div class="input_item">
                            <input type="text" placeholder="예) kream@kream.co.kr" class="input_txt in_essValue" id="uid" name="email" value="lee5031207@naver.com">
                        </div>
                    ...
                    <div class="input_box" id="name_input_box">
                        ...
                        <div class="input_item">
                            <input type="text" placeholder="이름을 입력하세요" class="input_txt" id="uname" name="name" value="이성욱">
                        </div>
                    </div>
                    ...
                    <div class="input_box has_button" id="password_input_box">
                        ...
                        <div class="input_item">
                            <input type="password" placeholder="영문, 숫자, 특수문자 조합 8-16자"  class="input_txt" id="upwd" name="password" maxlength="16" value="1q2w3e4r@">
                        </div>
                    ...
                    <div class="input_box" id="passwordcheck_input_box">
                        ...
                        <div class="input_item">
                            <input type="password" placeholder="비밀번호 확인"class="input_txt" id="urepwd" maxlength="16" value="1q2w3e4r@">
                        </div>
                    </div>
                    ...
                    <div class="input_box" id="tell_input_box">
                        ...
                        <div class="input_item">
                            <input type="text" placeholder="휴대폰 번호('-'제거 후 입력해주세요.)" class="input_txt" id="uphone" name="phone" maxlength="11" value="01074861207">
                        </div>
                    ...
                    <div class="input_box" id="birth_input_box">
                       ...
                       <div class="birth_box" id="birth_input_box">
                        <label>
                            <input type="text" name="yy" id="yy" placeholder="년(4자)" maxlength="4" value="1997"> 
                        ...
                        <input type="text" name="dd" id="dd" placeholder="일(2자)" maxlength="2" value="03">  일
                        </div> 
                    </div>
