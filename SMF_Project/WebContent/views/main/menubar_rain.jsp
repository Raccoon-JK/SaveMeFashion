...
<link rel="stylesheet" href="${pageContext.request.contextPath}/views/main/css/rain.css" type="text/css">
...
<body>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/views/main/js/rain.js" ></script>
